...
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/ynvfZFpK/photo-2025-06-16-09-11-33-7516472361781035036.jpg') # Scanner Code image 
...
premium = environ.get('PREMIUM_LOGS', '-1001518503232')
PREMIUM_LOGS = int(premium) if premium and id_pattern.search(premium) else None
# lock file, set file limit 
FILE_LIMITE = int(environ.get('FILE_LIMITE', 2))
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "LOOTERE") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002154482696 -1001767486774 -1002304474918 -1002617794966 -1001779982100 -1002192042126 -1002148604082').split()]
# post channel auto post new movie
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002081004430').split(','))))
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shaktiman:Shaktiman@cluster0.6y9wboo.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Shaktiman")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002186335716)) # movies request channel, else log channel
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1002244316214")) 
