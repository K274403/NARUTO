...
<b><spoiler>🔋 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ - <a href=https://t.me/KRISH_RULE>Mʀ Kʀɪsʜ™</b></spoiler></a>"""
...
★ Mᴇssᴀɢᴇ <code>{}</code>"""
    ...
    CAPTION = """
<b>📂 Fɪʟᴇ ɴᴀᴍᴇ : <b>[@RKMOVIEZIP]<a href="https://t.me/Rkmoviezip">{file_name}</a> 
<blockquote>✅ 𝘼𝙡𝙨𝙤 𝙟𝙤𝙞𝙣 #𝙍𝙠𝙢𝙤𝙫𝙞𝙚𝙯𝙞𝙥 – #𝙉𝙤𝟏 𝙏𝙚𝙡𝙚𝙜𝙧𝙖𝙢 𝙁𝙧𝙚𝙚 𝙈𝙤𝙫𝙞𝙚𝙨 𝘼𝙣𝙙 𝙒𝙚𝙗 𝙎𝙚𝙧𝙞𝙚𝙨 𝙀𝙣𝙩𝙚𝙧𝙩𝙖𝙞𝙣𝙢𝙚𝙣𝙩 𝘾𝙝𝙖𝙣𝙣𝙚𝙡. 
⏤‌‌𝗝⌡𝗼𝗶𝗻 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 –「 @RKMOVIEZIP 」🔥</blockquote></b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=https://t.me/KRISH_RULE>Mʀ Kʀɪsʜ™</a>"""
...
💵 ᴜᴘɪ ɪᴅ - <code>rkmovieszip@ybl</code>
